...
exports.RoleDbGatewayImpl = void 0;
const types_1 = require("@injection/types");
const databaseTables_1 = require("@models/databaseTables");
const inversify_1 = require("inversify");
let RoleDbGatewayImpl = class RoleDbGatewayImpl {
    constructor(models) {
    ...
    getRoleByUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.userDb.findByPk(userId);
            if (!user) {
                return null;
            }
            const role = yield this.roleDb.findByPk(user.roleId);
            return role;
        });
    }
...
RoleDbGatewayImpl = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.TYPES.Models))
], RoleDbGatewayImpl);
exports.RoleDbGatewayImpl = RoleDbGatewayImpl;
//# sourceMappingURL=roleDbGateway.js.map