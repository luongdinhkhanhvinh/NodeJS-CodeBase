...
let UserRepositoryImpl = class UserRepositoryImpl {
    ...
    checkUserExist(user) {
        if (!user) {
            throw new illegalParameterError_1.IllegalParameterError("UserRepository", "checkUserExist", "User does not exist");
        }
    }
};
UserRepositoryImpl = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.TYPES.UserDbGateway))
], UserRepositoryImpl);
